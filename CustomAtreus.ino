...
void setup() {
  ...
  AutoShift.setEnabled(AutoShift.letterKeys() | AutoShift.numberKeys() | AutoShift.symbolKeys());
  // Set the AutoShift long-press time in milliseconds:
  AutoShift.setTimeout(185);
  AutoShift.enable();
